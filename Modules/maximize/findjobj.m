...
% $Revision: 1.26 $  $Date: 2010/02/04 23:55:21 $
...
%}
        ...
        set(jTreeObj, 'MousePressedCallback', {@treeMousePressedCallback,tree_h});  % context (right-click) menu
    ...
    function jmenu = setTreeContextMenu(obj,node,tree_h)
          ...
          set(menuItem1,'ActionPerformedCallback',{@btExport_Callback,{obj,'findjobj_hdls'}});
          set(menuItem2,'ActionPerformedCallback',{@btExport_Callback,{obj,[]}});
          set(menuItem3,'ActionPerformedCallback',{@requestFocus,obj});
          set(menuItem4,'ActionPerformedCallback',{@flashComponent,{obj,0.2,3}});
          set(menuItem5,'ActionPerformedCallback',{@nodeSelected,{tree_h,node}});
          set(menuItem6,'ActionPerformedCallback',{@btInspect_Callback,obj});
          ...
          if ~isempty(handleValue)
              ...
              set(menuItem0a,'ActionPerformedCallback',sprintf('clipboard(''copy'',%.99g)',handleValue));
