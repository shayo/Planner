function astrctMesh= fnCreateCylinderMeshWithBottom(fDiameterMM, fZdepthDown,fZdepthUp, iQuat,afColor)
...
strctMesh.m_a2fVertices = [[0;0;fZdepthDown], apt2fDownVertices];
strctMesh.m_a2iFaces = zeros(3, iNumTriangles);
