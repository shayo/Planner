...
if ~isempty(Tmp)
    ...
    g_strctModule.m_acAnatVol{g_strctModule.m_iCurrAnatVol}.m_a2fRegToStereoTactic = fnRotateVectorAboutAxis4D([1 0 0],pi)* inv(g_strctModule.m_acAnatVol{g_strctModule.m_iCurrAnatVol}.m_strctCrossSectionHoriz.m_a2fM);
