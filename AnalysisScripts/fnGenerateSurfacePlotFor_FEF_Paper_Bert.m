function fnGenerateSurfacePlotFor_FEF_Paper_Bert()
...
TestPlannerAPI_FunctionalOverlaySurfacesAux(22,strWhiteMatterFile,strPialFile,strInflatedFile,strCurvatureFile,strThicknessFile,iAnatomicalVolumeIndex,'111222Bert_O-G',iSelectedROI,-5,-3)
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(0);
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(2);

TestPlannerAPI_FunctionalOverlaySurfacesAux(22,strWhiteMatterFile,strPialFile,strInflatedFile,strCurvatureFile,strThicknessFile,iAnatomicalVolumeIndex,'111222Bert_E-G',iSelectedROI,-5,-3)
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(0);
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(2);

TestPlannerAPI_FunctionalOverlaySurfacesAux(22,strWhiteMatterFile,strPialFile,strInflatedFile,strCurvatureFile,strThicknessFile,iAnatomicalVolumeIndex,'111222Bert_OE-G',iSelectedROI,-5,-3)
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(0);

TestPlannerAPI_FunctionalOverlaySurfacesAux(22,strWhiteMatterFile,strPialFile,strInflatedFile,strCurvatureFile,strThicknessFile,iAnatomicalVolumeIndex,'111222Bert_OE-E',iSelectedROI,-5,-3)
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(0);


TestPlannerAPI_FunctionalOverlaySurfacesAux(22,strWhiteMatterFile,strPialFile,strInflatedFile,strCurvatureFile,strThicknessFile,iAnatomicalVolumeIndex,'120613-14_3Cond_E-G',iSelectedROI,-9,-3)
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(0);
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(2);

TestPlannerAPI_FunctionalOverlaySurfacesAux(23,strWhiteMatterFile,strPialFile,strInflatedFile,strCurvatureFile,strThicknessFile,iAnatomicalVolumeIndex,'120613-14_3Cond_O-G',iSelectedROI,-5,-3)
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(0);
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(2);

TestPlannerAPI_FunctionalOverlaySurfacesAux(24,strWhiteMatterFile,strPialFile,strInflatedFile,strCurvatureFile,strThicknessFile,iAnatomicalVolumeIndex,'120613-14_3Cond_OE-G',iSelectedROI,-9,-3)
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(0);
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(2);

TestPlannerAPI_FunctionalOverlaySurfacesAux(25,strWhiteMatterFile,strPialFile,strInflatedFile,strCurvatureFile,strThicknessFile,iAnatomicalVolumeIndex,'120613-14_3Cond_OE-E',iSelectedROI,-5,-3)
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(0);
fnGenerateSurfacePlotFor_FEF_Paper_CameraView(2);
...
strLH_Root = 'D:\Data\Doris\Planner\Bert\New Reference For Surface Recon\LH\';
